...
# Training data
# Usage
training_json_path = './shakespeare/data/train/all_data_niid_01_keep_0_train_9.json'
...
# Testinging data
# Usage
testing_json_path = './shakespeare/data/test/all_data_niid_01_keep_0_test_9.json'
